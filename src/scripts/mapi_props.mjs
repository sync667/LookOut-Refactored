...
export const MAPI_UNSPECIFIED = 0x0000; // MAPI Unspecified
export const MAPI_NULL = 0x0001; // MAPI null property
export const MAPI_SHORT = 0x0002; // MAPI short (signed 16 bits)
export const MAPI_INT = 0x0003; // MAPI integer (signed 32 bits)
export const MAPI_FLOAT = 0x0004; // MAPI float (4 bytes)
export const MAPI_DOUBLE = 0x0005; // MAPI double
export const MAPI_CURRENCY = 0x0006; // MAPI currency (64 bits)
export const MAPI_APPTIME = 0x0007; // MAPI application time
export const MAPI_ERROR = 0x000a; // MAPI error (32 bits)
export const MAPI_BOOLEAN = 0x000b; // MAPI boolean (16 bits)
export const MAPI_OBJECT = 0x000d; // MAPI embedded object
export const MAPI_INT64 = 0x0014; // MAPI 8 byte signed int
export const MAPI_STRING = 0x001e; // MAPI string
export const MAPI_UNICODE_STRING = 0x001f; // MAPI unicode-string (null terminated)
export const MAPI_SYSTIME = 0x0040; // MAPI time (64 bits)
export const MAPI_CLSID = 0x0048; // MAPI OLE GUID
export const MAPI_BINARY = 0x0102; // MAPI binary
export const MAPI_MULTI_STRING = 0x101F; // MAPI multiple string

export function mattr_type_to_string(mattr_type) {
  switch (mattr_type) {
...
export const MAPI_ACKNOWLEDGEMENT_MODE = 0x0001;
export const MAPI_TEMPLATE_DATA = 0x0001;
export const MAPI_MEETING_ATTENDEE_CRITICAL_CHANGE = 0x0001;
export const MAPI_ALTERNATE_RECEIPIANT_ALLOWED = 0x0002;
export const MAPI_MEETING_WHERE = 0x0002;
export const MAPI_AUTHORIZING_USERS = 0x0003;
export const MAPI_MEETING_GLOBAL_OBJECT_ID = 0x0003;
export const MAPI_AUTO_FORWARD_COMMENT = 0x0004;
export const MAPI_SCRIPT_DATA = 0x0004;
export const MAPI_MEETING_IS_SILENT = 0x0004;
export const MAPI_AUTO_FORWARDED = 0x0005;
export const MAPI_MEETING_IS_RECURRING = 0x0005;
export const MAPI_CONTENT_CONFIDENTIALITY_ALGORITHM_ID = 0x0006;
export const MAPI_MEETING_REQUIRED_ATTENDEES = 0x0006;
export const MAPI_CONTENT_CORRELATOR = 0x0007;
export const MAPI_MEETING_OPTIONAL_ATTENDEES = 0x0007;
export const MAPI_CONTENT_IDENTIFIER = 0x0008;
export const MAPI_MEETING_RESOURCE_ATTENDEES = 0x0008;
export const MAPI_MEETING_DELEGATE_MAIL = 0x0009;
export const MAPI_CONTENT_RETURN_REQUESTED = 0x000A;
export const MAPI_MEETING_IS_EXCEPTION = 0x000A;
export const MAPI_CONVERSATION_KEY = 0x000B;
export const MAPI_MEETING_SINGLE_INVITE = 0x000B;
export const MAPI_MEETING_TIME_ZONE = 0x000C;
export const MAPI_CONVERSION_EITS = 0x000C;
export const MAPI_DEFERRED_DELIVERY_TIME = 0x000F;
export const MAPI_DELIVER_TIME = 0x0010;
export const MAPI_DISCARD_REASON = 0x0011;
export const MAPI_DISCLOSURE_OF_RECIPIENTS = 0x0012;
export const MAPI_DL_EXPANSION_HISTORY = 0x0013;
export const MAPI_MEETING_MONTH_INTERVAL = 0x0013;
export const MAPI_DL_EXPANSION_PROHIBITED = 0x0014;
export const MAPI_EXPIRY_TIME = 0x0015;
export const MAPI_IMPLICIT_CONVERSION_PROHIBITED = 0x0016;
export const MAPI_IMPORTANCE = 0x0017;
export const MAPI_IPM_ID = 0x0018;
export const MAPI_LATEST_DELIVERY_TIME = 0x0019;
export const MAPI_MESSAGE_CLASS = 0x001A;
export const MAPI_MEETING_OWNER_CRITICAL_CHANGE = 0x001A;
export const MAPI_MESSAGE_DELIVERY_ID = 0x001B;
export const MAPI_MEETING_CALENDAR_TYPE = 0x001C;
export const MAPI_MEETING_ALL_ATTENDEES = 0x001D;
export const MAPI_MESSAGE_SECURITY_LABEL = 0x001E;
export const MAPI_OBSOLETED_IPMS = 0x001F;
export const MAPI_ORIGINALLY_INTENDED_RECIPIENT_NAME = 0x0020;
export const MAPI_ORIGINAL_EITS = 0x0021;
export const MAPI_ORIGINATOR_CERTIFICATE = 0x0022;
export const MAPI_ORIGINATOR_DELIVERY_REPORT_REQUESTED = 0x0023;
export const MAPI_MEETING_CLEAN_GLOBAL_OBJECT_ID = 0x0023;
export const MAPI_ORIGINATOR_RETURN_ADDRESS = 0x0024;
export const MAPI_MEETING_MESSAGE_CLASS = 0x0024;
export const MAPI_PARENT_KEY = 0x0025;
export const MAPI_PRIORITY = 0x0026;
export const MAPI_MEETING_TYPE = 0x0026;
export const MAPI_MEETING_OLD_LOCATION = 0x0028;
export const MAPI_READ_RECEIPT_REQUESTED = 0x0029;
export const MAPI_RECIPIENT_REASSIGNMENT_PROHIBITED = 0x002B;
export const MAPI_RELATED_IPMS = 0x002D;
export const MAPI_ORIGINAL_SENSITIVITY = 0x002E;
export const MAPI_REPORT_TAG = 0x0031;
export const MAPI_SENSITIVITY = 0x0036;
export const MAPI_SUBJECT = 0x0037;
export const MAPI_CLIENT_SUBMIT_TIME = 0x0039;
export const MAPI_SUBJECT_PREFIX = 0x003D;
export const MAPI_RECEIVED_BY_NAME = 0x0040;
export const MAPI_SENT_REPRESENTING_ENTRYID = 0x0041;
export const MAPI_SENT_REPRESENTING_NAME = 0x0042;
export const MAPI_RCVD_REPRESENTING_ENTRYID = 0x0043;
export const MAPI_RCVD_REPRESENTING_NAME = 0x0044;
export const MAPI_REPORT_ENTRYID = 0x0045;
export const MAPI_READ_RECEIPT_ENTRYID = 0x0046;
export const MAPI_MESSAGE_SUBMISSION_ID = 0x0047;
export const MAPI_PROVIDER_SUBMIT_TIME = 0x0048;
export const MAPI_ORIGINAL_SUBJECT = 0x0049;
export const MAPI_DISC_VAL = 0x004A;
export const MAPI_ORIG_MESSAGE_CLASS = 0x004B;
export const MAPI_ORIGINAL_AUTHOR_ENTRYID = 0x004C;
export const MAPI_ORIGINAL_AUTHOR_NAME = 0x004D;
export const MAPI_MESSAGE_TO_ME = 0x0057;
export const MAPI_MESSAGE_CC_ME = 0x0058;
export const MAPI_ORIG_SENT_REPRESENTING_NAME = 0x005D;
export const MAPI_ORIG_SENT_REPRESENTING_ENTRYID = 0x005E;
export const MAPI_START_DATE = 0x0060;
export const MAPI_END_DATE = 0x0061;
export const MAPI_OWNER_APPT_ID = 0x0062;
export const MAPI_RESPONSE_REQUESTED = 0x0063;
export const MAPI_SENT_REPRESENTING_ADDR_TYPE = 0x0064;
export const MAPI_SENT_REPRESENTING_EMAIL = 0x0065;
export const MAPI_ORIG_SENT_REPRESENTING_EMAIL = 0x0069;
export const MAPI_CONVERSATION_TOPIC = 0x0070;
export const MAPI_CONVERSATION_INDEX = 0x0071;
export const MAPI_RECEIVED_BY_ADDRTYPE = 0x0075;
export const MAPI_RECEIVED_BY_EMAIL_ADDRESS = 0x0076;
export const MAPI_TRANSPORT_MESSAGE_HEADERS = 0x007D;
export const MAPI_TNEF_CORRELATION_KEY = 0x007F;
export const MAPI_EXPLICIT_CONVERSION = 0x0C01;
export const MAPI_MESSAGE_TOKEN = 0x0C03;
export const MAPI_REPLY_REQUESTED = 0x0C17;
export const MAPI_SENDER_NAME = 0x0C1A;
export const MAPI_SENDER_SEARCH_KEY = 0x0C1D;
export const MAPI_SENDER_EMAIL_ADDRESS = 0x0C1F;
export const MAPI_DELETE_AFTER_SUBMIT = 0x0E01;
export const MAPI_DISPLAY_BCC = 0x0E02;
export const MAPI_DISPLAY_CC = 0x0E03;
export const MAPI_DISPLAY_TO = 0x0E04;
export const MAPI_PARENT_DISPLAY = 0x0E05;
export const MAPI_MESSAGE_DELIVERY_TIME = 0x0E06;
export const MAPI_MESSAGE_FLAGS = 0x0E07;
export const MAPI_MESSAGE_SIZE = 0x0E08;
export const MAPI_PARENT_ENTRYID = 0x0E09;
export const MAPI_SENTMAIL_ENTRYID = 0x0E0A;
export const MAPI_MESSAGE_RECIPIENTS = 0x0E12;
export const MAPI_MESSAGE_ATTACHMENTS = 0x0E13;
export const MAPI_SUBMIT_FLAGS = 0x0E14;
export const MAPI_HASATTACH = 0x0E1B;
export const MAPI_BODY_CRC = 0x0E1C;
export const MAPI_NORMALIZED_SUBJECT = 0x0E1D;
export const MAPI_RTF_IN_SYNC = 0x0E1F;
export const MAPI_ATTACH_SIZE = 0x0E20;
export const MAPI_ATTACH_NUM = 0x0E21;
export const MAPI_PREPROCESS = 0x0E22;
export const MAPI_PRIMARY_SEND_ACCOUNT = 0x0E28;
export const MAPI_NEXT_SEND_ACCOUNT = 0x0E29;
export const MAPI_ACCESS = 0x0FF4;
export const MAPI_ROW_TYPE = 0x0FF5;
export const MAPI_INSTANCE_KEY = 0x0FF6;
export const MAPI_ACCESS_LEVEL = 0x0FF7;
export const MAPI_MAPPING_SIGNATURE = 0x0FF8;
export const MAPI_RECORD_TYPE = 0x0FF9;
export const MAPI_MESSAGE_TYPE = 0x0FFA;
export const MAPI_OBJECT_TYPE = 0x0FFE;
export const MAPI_ENTRY_ID = 0x0FFF;
export const MAPI_BODY = 0x1000;
export const MAPI_REPORT_TEXT = 0x1001;
export const MAPI_RTF_SYNC_BODY_CRC = 0x1006;
export const MAPI_RTF_SYNC_BODY_COUNT = 0x1007;
export const MAPI_RTF_SYNC_BODY_TAG = 0x1008;
export const MAPI_RTF_COMPRESSED = 0x1009;
export const MAPI_RTF_SYNC_PREFIX_COUNT = 0x1010;
export const MAPI_RTF_SYNC_TRAILING_COUNT = 0x1011;
export const MAPI_BODY_HTML = 0x1013;
export const MAPI_SMTP_MESSAGE_ID = 0x1035;
export const MAPI_CONFLICT_ITEMS = 0x1098;
export const MAPI_URL_COMP_NAME = 0x10F3;
export const MAPI_ATTRIBUTE_READ_ONLY = 0x10F6;
export const MAPI_CATEGORIES = 0x2328;
export const MAPI_DISPLAY_NAME = 0x3001;
export const MAPI_EMAIL_ADDRESS = 0x3003;
export const MAPI_CREATION_TIME = 0x3007;
export const MAPI_MODIFICATION_TIME = 0x3008;
export const MAPI_SEARCH_KEY = 0x300B;
export const MAPI_STORE_SUPPORT_MASK = 0x340D;
export const MAPI_MDB_PROVIDER = 0x3414;
export const MAPI_CONTAINER_FLAGS = 0x3600;
export const MAPI_FOLDER_TYPE = 0x3601;
export const MAPI_CONTENT_COUNT = 0x3602;
export const MAPI_CONTENT_UNREAD = 0x3603;
export const MAPI_CONTAINER_HIERARCHY = 0x360E;
export const MAPI_CONTAINER_CONTENTS = 0x360F;
export const MAPI_FOLDER_ASSOCIATED_CONTENTS = 0x3610;
export const MAPI_CONTAINER_CLASS = 0x3613;
export const MAPI_CONTAINER_MODIFY_VERSION = 0x3614;
export const MAPI_ATTACHMENT_X400_PARAMETERS = 0x3700;
export const MAPI_ATTACH_DATA_OBJ = 0x3701;
export const MAPI_ATTACH_ENCODING = 0x3702;
export const MAPI_ATTACH_EXTENSION = 0x3703;
export const MAPI_ATTACH_FILENAME = 0x3704;
export const MAPI_ATTACH_METHOD = 0x3705;
export const MAPI_ATTACH_LONG_FILENAME = 0x3707;
export const MAPI_ATTACH_PATHNAME = 0x3708;
export const MAPI_ATTACH_RENDERING = 0x3709;
export const MAPI_ATTACH_TAG = 0x370A;
export const MAPI_ATTACHMENT_RENDERING_POSITION = 0x370B;
export const MAPI_ATTACH_TRANSPORT_NAME = 0x370C;
export const MAPI_ATTACH_LONG_PATHNAME = 0x370D;
export const MAPI_ATTACH_MIME_TAG = 0x370E;
export const MAPI_ATTACH_ADDITIONAL_INFO = 0x370F;
export const MAPI_ATTACH_MIME_SEQUENCE = 0x3710;
export const MAPI_ATTACH_CONTENT_ID = 0x3712;
export const MAPI_ATTACH_CONTENT_LOCATION = 0x3713;
export const MAPI_ATTACH_FLAGS = 0x3714;
export const MAPI_DISPLAY_TYPE = 0x3900;
export const MAPI_TEMPLATEID = 0x3902;
export const MAPI_SMTP_ADDRESS = 0x39FE;
export const MAPI_ACCOUNT = 0x3A00;
export const MAPI_CONTACT_CALLBACK_PHONE = 0x3A02;
export const MAPI_GENERATION = 0x3A05;
export const MAPI_GIVEN_NAME = 0x3A06;
export const MAPI_CONTACT_BUSINESS_PHONE = 0x3A08;
export const MAPI_CONTACT_HOME_PHONE = 0x3A09;
export const MAPI_INITIALS = 0x3A0A;
export const MAPI_KEYWORD = 0x3A0B;
export const MAPI_LANGUAGE = 0x3A0C;
export const MAPI_LOCATION = 0x3A0D;
export const MAPI_SURNAME = 0x3A11;
export const MAPI_COMPANY_NAME = 0x3A16;
export const MAPI_TITLE = 0x3A17;
export const MAPI_DEPARTMENT_NAME = 0x3A18;
export const MAPI_CONTACT_PRIMARY_PHONE = 0x3A1A;
export const MAPI_CONTACT_BUSINESS_PHONE_2 = 0x3A1B;
export const MAPI_CONTACT_OTHER_PHONE = 0x3A1F;
export const MAPI_CONTACT_MOBILE_PHONE = 0x3A08;
export const MAPI_CONTACT_BUSINESS_FAX = 0x3A24;
export const MAPI_COUNTRY = 0x3A26;
export const MAPI_LOCALITY = 0x3A27;
export const MAPI_STATE_PROVINCE = 0x3A28;
export const MAPI_HOME_PHONE_2 = 0x3A2F;
export const MAPI_CONTACT_SEND_RICH_INFO = 0x3A40;
export const MAPI_CONTACT_MIDDLE_NAME = 0x3A44;
export const MAPI_DISPLAY_NAME_PREFIX = 0x3A45;
export const MAPI_CONTACT_COMPUTER_NETWORK = 0x3A49;
export const MAPI_CONTACT_TDD_PHONE = 0x3A4B;
export const MAPI_CONTACT_COMPANY_MAIN_PHONE = 0x3A57;
export const MAPI_CONTACT_CHILDRENS_NAMES = 0x3A58;
export const MAPI_INTERNET_CPID = 0x3FDE;
export const MAPI_CONFLICT_ENTRY_ID = 0x3FF0;
export const MAPI_MESSAGE_LOCALE_ID = 0x3FF1;
export const MAPI_CREATOR_NAME = 0x3FF8;
export const MAPI_CREATOR_ENTRY_ID = 0x3FF9;
export const MAPI_LAST_MODIFIER_NAME = 0x3FFA;
export const MAPI_LAST_MODIFIER_ENTRY_ID = 0x3FFB;
export const MAPI_CODE_PAGE = 0x3FFD;
export const MAPI_SENDER_FLAGS = 0x4019;
export const MAPI_SENT_REPRESENTING_FLAGS = 0x401A;
export const MAPI_SENDER_SIMPLE_DISPLAY_NAME = 0x4030;
export const MAPI_SENT_REPRESENTING_SIMPLE_DISPLAY_NAME = 0x4031;
export const MAPI_CREATOR_SIMPLE_DISPLAY_NAME = 0x4038;
export const MAPI_LAST_MODIFER_SIMPLE_DISPLAY_NAME = 0x4039;
export const MAPI_CONTENT_FILTER_SPAM_CONFIDENCE = 0x4076;
export const MAPI_INET_MAIL_OVERRIDE_FORMAT = 0x5902;
export const MAPI_MSG_EDITOR_FORMAT = 0x5909;
export const MAPI_EXCEPTION_REPLACE_TIME = 0x7FF9;
export const MAPI_ATTACHMENT_LINK_ID = 0x7FFA;
export const MAPI_EXCEPTION_START_TIME = 0x7FFB;
export const MAPI_EXCEPTION_END_TIME = 0x7FFC;
export const MAPI_ATTACHMENT_FLAGS = 0x7FFD;
export const MAPI_ATTACHMENT_HIDDEN = 0x7FFE;
export const MAPI_ATTACHMENT_CONTACT_PHOTO = 0x7FFF;
export const MAPI_CONTACT_FILE_UNDER = 0x8005;
export const MAPI_CONTACT_LAST_AND_FIRST_NAME = 0x8017;
export const MAPI_CONTACT_COMPANY_AND_FULL_NAME = 0x8018;
export const MAPI_ADDRESS_BOOK_PROVIDER_EMAIL_LIST = 0x8028;
export const MAPI_ADDRESS_BOOK_PROVIDER_ARRAY_TYPE = 0x8029;
export const MAPI_CONTACT_EMAIL_1_FULL = 0x8080;
export const MAPI_CONTACT_EMAIL_1_ADDRESS_TYPE = 0x8082;
export const MAPI_CONTACT_EMAIL_1_ADDRESS = 0x8083;
export const MAPI_CONTACT_EMAIL_1_DISPLAY_NAME = 0x8084;
export const MAPI_CONTACT_EMAIL_1_ENTRY_ID = 0x8085;
export const MAPI_CONTACT_EMAIL_2_FULL = 0x8090;
export const MAPI_CONTACT_EMAIL_2_ADDRESS_TYPE = 0x8092;
export const MAPI_CONTACT_EMAIL_2_ADDRESS = 0x8093;
export const MAPI_CONTACT_EMAIL_2_DISPLAY_NAME = 0x8094;
export const MAPI_CONTACT_EMAIL_2_ENTRY_ID = 0x8095;
export const MAPI_CONTACT_COUNTRY_CODE = 0x80DD;
export const MAPI_TASK_STATUS = 0x8101;
export const MAPI_TASK_PERCENT_COMPLETE = 0x8102;
export const MAPI_TASK_TEAM_TASK = 0x8103;
export const MAPI_TASK_START_DATE = 0x8104;
export const MAPI_TASK_DUE_DATE = 0x8105;
export const MAPI_TASK_RESET_REMINDER = 0x8107;
export const MAPI_TASK_ACCEPTED = 0x8108;
export const MAPI_TASK_DEAD_OCCURRENCE = 0x8109;
export const MAPI_TASK_DATE_COMPLETED = 0x810F;
export const MAPI_TASK_ACTUAL_EFFORT = 0x8110;
export const MAPI_TASK_ESTIMATED_EFFORT = 0x8111;
export const MAPI_TASK_VERSION = 0x8112;
export const MAPI_TASK_STATE = 0x8113;
export const MAPI_TASK_LAST_UPDATE = 0x8115;
export const MAPI_TASK_RECURRENCE = 0x8116;
export const MAPI_TASK_ASSIGNERS = 0x8117;
export const MAPI_TASK_STATUS_ON_COMPLETE = 0x8119;
export const MAPI_TASK_HISTORY = 0x811A;
export const MAPI_TASK_UPDATES = 0x811B;
export const MAPI_TASK_COMPLETE = 0x811C;
export const MAPI_TASK_F_CREATOR = 0x811E;
export const MAPI_TASK_MULTIPLE_RECIPIENTS = 0X8120;
export const MAPI_TASK_ASSIGNER = 0x8121;
export const MAPI_TASK_LAST_USER = 0x8122;
export const MAPI_TASK_ORDINAL = 0x8123;
export const MAPI_TASK_NO_COMPUTE = 0x8124;
export const MAPI_TASK_LAST_DELEGATE = 0x8125;
export const MAPI_TASK_F_RECURRING = 0x8126;
export const MAPI_TASK_ROLE = 0x8127;
export const MAPI_TASK_OWNERSHIP = 0x8129;
export const MAPI_TASK_ACCEPTANCE_STATE = 0x812A;
export const MAPI_TASK_F_FIX_OFFLINE = 0x812C;
export const MAPI_APPOINTMENT_SEND_AS_ICAL = 0x8200;
export const MAPI_APPOINTMENT_SEQUENCE = 0x8201;
export const MAPI_APPOINTMENT_SEQUENCE_TIME = 0x8202;
export const MAPI_APPOINTMENT_LAST_SEQUENCE = 0x8203;
export const MAPI_APPOINTMENT_CHANGE_HIGHLIGHT = 0x8204;
export const MAPI_APPOINTMENT_BUSY_STATUS = 0x8205; // (0 = free, 1 = tentative, 2 = busy, 3 out of office)
export const MAPI_APPOINTMENT_AUXILIARY_FLAGS = 0x8207;
export const MAPI_APPOINTMENT_LOCATION = 0x8208;
export const MAPI_APPOINTMENT_START_WHOLE = 0x820D;
export const MAPI_APPOINTMENT_END_WHOLE = 0x820E;
export const MAPI_APPOINTMENT_END_DATE = 0x8211;
export const MAPI_APPOINTMENT_START_DATE = 0x8212;
export const MAPI_APPOINTMENT_DURATION = 0x8213;
export const MAPI_APPOINTMENT_COLOR = 0x8214; // (1 = red, 2 = blue, 3 = green, 4 = grey, 5 = orange, 6 = cyan, 7 = olive, 8 = purple, 9 = teal, a = yellow)
export const MAPI_APPOINTMENT_ALL_DAY = 0x8215; // subtype
export const MAPI_APPOINTMENT_RECUR = 0x8216;
export const MAPI_APPOINTMENT_STATE_FLAGS = 0x8217; // (1 = M = meeting, 2 = R = received, 3 = C = canceled)
export const MAPI_APPOINTMENT_RESPONSE_STATUS = 0x8218; // (0 = not req'd, 1 = organized, 2 = tentative, 3 = accepted, 4 = declined, 5 = not responded)
export const MAPI_APPOINTMENT_REPLY_TIME = 0x8230;
export const MAPI_APPOINTMENT_RECURRENCE_SET = 0x8223; // Recurring (0 not, 1 daily, 2 weekly, etc)
export const MAPI_APPOINTMENT_INTENDED_BUSY_STATUS = 0x8224; // (0 = free, 1 = tentative, 2 = busy, 3 out of office)
export const MAPI_APPOINTMENT_F_INVITED = 0x8229;
export const MAPI_APPOINTMENT_REPLY_NAME = 0x8230;
export const MAPI_APPOINTMENT_RECURRENCE_TYPE = 0x8231;
export const MAPI_APPOINTMENT_RECURRENCE_PATTERN = 0x8232;
export const MAPI_APPOINTMENT_RECURRENCE_TIMEZONE = 0x8234;
export const MAPI_APPOINTMENT_RECURRENCE_START = 0x8235;
export const MAPI_APPOINTMENT_RECURRENCE_END = 0x8236;
export const MAPI_APPOINTMENT_ALL_ATTENDEES = 0x8238;
export const MAPI_APPOINTMENT_AUTO_FILL_LOCATION = 0x823A;
export const MAPI_APPOINTMENT_REQUIRED_ATTENDEES = 0x823B;
export const MAPI_APPOINTMENT_OPTIONAL_ATTENDEES = 0x823C;
export const MAPI_APPOINTMENT_UNSENDABLE_RECIPIENTS = 0x823D;
export const MAPI_APPOINTMENT_CONFERENCING_CHECK = 0x8240;
export const MAPI_APPOINTMENT_CONFERENCING_TYPE = 0x8241;
export const MAPI_APPOINTMENT_DIRECTORY = 0x8242;
export const MAPI_APPOINTMENT_ORGANIZER_ALIAS = 0x8243;
export const MAPI_APPOINTMENT_AUTO_START_CHECK = 0x8244;
export const MAPI_APPOINTMENT_AUTO_START_WHEN = 0x8245;
export const MAPI_APPOINTMENT_ALLOW_EXTERNAL_CHECK = 0x8246;
export const MAPI_APPOINTMENT_COLLABORATE_DOC = 0x8247;
export const MAPI_APPOINTMENT_NET_SHOW_URL = 0x8248;
export const MAPI_APPOINTMENT_ONLINE_PASSWORD = 0x8249;
export const MAPI_APPOINTMENT_PROPOSED_START_WHOLE = 0x8250;
export const MAPI_APPOINTMENT_PROPOSED_END_WHOLE = 0x8251;
export const MAPI_APPOINTMENT_TZ_START_DISPLAY = 0x825E;
export const MAPI_APPOINTMENT_TZ_END_DISPLAY = 0x825F;
export const MAPI_APPOINTMENT_PROPOSED_DURATION = 0x8256;
export const MAPI_APPOINTMENT_COUNTER_PROPOSAL = 0x8257;
export const MAPI_APPOINTMENT_PROPOSAL_NUMBER = 0x8259;
export const MAPI_APPOINTMENT_NOT_ALLOW_PROPOSE = 0x825A;
export const MAPI_COMMON_REMINDER_MINUTES_BEFORE = 0x8501;
export const MAPI_COMMON_REMINDER_DATE = 0x8502;
export const MAPI_COMMON_REMINDER_SET = 0x8503;
export const MAPI_COMMON_PRIVATE = 0x8506;
export const MAPI_COMMON_AGING_DONT_AGE = 0x850E;
export const MAPI_COMMON_ALLOW_EXCEPTION_DELETE = 0x8510;
export const MAPI_COMMON_START = 0x8516;
export const MAPI_COMMON_END = 0x8517;
export const MAPI_TASK_MODE = 0x8518;
export const MAPI_COMMON_REMINDER_OVERRIDE = 0x851C;
export const MAPI_COMMON_REMINDER_TYPE = 0x851D;
export const MAPI_COMMON_REMINDER_PLAY_SOUND = 0x851E;
export const MAPI_COMMON_COMPANIES = 0x8539;
export const MAPI_COMMON_CONTACTS = 0x853A;
export const MAPI_NEXT_REMINDER_TIME = 0x8560; // Reminder date
export const MAPI_USE_TNEF = 0x8582;
export const MAPI_COMMON_CONTACT_LINK_NAME = 0x8586;
export const MAPI_COMMON_CLASSIFIED = 0x85B5;
export const MAPI_COMMON_CLASSIFICATION = 0x85B6;
export const MAPI_COMMON_CLASSIFICATION_DESCRIPTION = 0x85B7;
export const MAPI_COMMON_CLASSIFICATION_GUID = 0x85B8;
export const MAPI_COMMON_CLASSIFICATION_KEEP = 0x85BA;
...
export function mattr_name_to_string(mattr_name, msg_class) {

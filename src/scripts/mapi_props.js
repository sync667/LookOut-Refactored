...
function mattr_type_to_string(mattr_type) { // eslint-disable-line no-unused-vars
  switch (mattr_type) {
...
const _MAPI_ORIG_SENT_REPRESENTING_NAME = 0x005D; // eslint-disable-line no-unused-vars
const _MAPI_ORIG_SENT_REPRESENTING_ENTRYID = 0x005E; // eslint-disable-line no-unused-vars
...
const _MAPI_ORIG_SENT_REPRESENTING_EMAIL = 0x0069; // eslint-disable-line no-unused-vars
...
const _MAPI_SMTP_ADDRESS = 0x39FE; // eslint-disable-line no-unused-vars
...
function mattr_name_to_string(mattr_name, msg_class) { // eslint-disable-line no-unused-vars
